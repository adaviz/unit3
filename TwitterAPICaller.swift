...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "9kedbVV08nMqRFufWq9ZFqxDl", consumerSecret: "geGoGxQKa6Dai351r5zIghdVn6ZDtBT6NXEC6ZVv77zdoH6Uca")
    var loginSuccess: (() -> ())?
